...
//        'skin' => 'thebigreason',
    ...
    private static $custom_menu = array('language' => 'ru',
        // General options
        'theme' => "advanced",
        'plugins' => "inlinepopups,fullscreen,advimage,contextmenu",
//        'skin' => 'o2k7',
//        'skin_variant' => "silver",
//        'skin_variant' => "black",
//        'skin' => 'thebigreason',
        'skin' => 'cirkuit',
        // Theme options
        'theme_advanced_buttons1' => "bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,image,formatselect",
    ...
    public function init()
    {
        ...
        $this->settings = array_merge(self::$custom_menu, $this->settings);
